...
<body class="stretched">
							...
							<ul class="menu-container">
								<li class="menu-item">
									...
									<ul class="sub-menu-container">
										<li class="menu-item">
											<a class="menu-link" href="niche-demos.html">
												<div>Niche Demos</div>
											</a>
										</li>
										<li class="menu-item">
										...
										<li class="menu-item">
											<a class="menu-link" href="blocks.html">
												<div>Blocks</div>
											</a>
										</li>
										<li class="menu-item">
										...
										<li class="menu-item">
											...
											<ul class="sub-menu-container">
												<li class="menu-item">
													...
													<ul class="sub-menu-container">
														<li class="menu-item">
															<a class="menu-link" href="header-saas.html">
																<div>SAAS</div>
															</a>
														</li>
														<li class="menu-item">
															<a class="menu-link" href="header-ecommerce-minimal.html">
																<div>eCommerce Minimal</div>
															</a>
														</li>
														<li class="menu-item">
															<a class="menu-link" href="header-directory.html">
																<div>Directory</div>
															</a>
														</li>
														<li class="menu-item">
														...
														<li class="menu-item">
															<a class="menu-link" href="header-floating-small.html">
																<div>Floating Small</div>
															</a>
														</li>
														<li class="menu-item">
															<a class="menu-link" href="header-offcanvas-overlay.html">
																<div>Off-Canvas Overlay</div>
															</a>
														</li>
														<li class="menu-item">
															<a class="menu-link" href="header-full-menu.html">
																<div>Full Menu</div>
															</a>
														</li>
														<li class="menu-item">
															<a class="menu-link" href="header-full-border.html">
																<div>Full Border</div>
															</a>
														</li>
														<li class="menu-item">
															<a class="menu-link" href="header-sticky-on-scrollup.html">
											...
											<div class="mega-menu-content">
												<div class="row mx-0">
													<ul class="sub-menu-container mega-menu-column col">
														...
														<li class="menu-item">
															<a class="menu-link" href="split-menu-2.html">
										...
										<li class="menu-item">
											...
											<ul class="sub-menu-container">
												<li class="menu-item">
													...
													<ul class="sub-menu-container">
														<li class="menu-item">
															<a class="menu-link" href="page-title-block.html">
																<div>Block</div>
															</a>
														</li>
														<li class="menu-item">
															<a class="menu-link" href="page-title-bold.html">
																<div>Bold</div>
															</a>
														</li>
														<li class="menu-item">
															<a class="menu-link" href="page-title-fancy.html">
																<div>Fancy</div>
															</a>
														</li>
														<li class="menu-item">
															<a class="menu-link" href="page-title-fancy-alt.html">
																<div>Fancy Alternate</div>
															</a>
														</li>
														<li class="menu-item">
															<a class="menu-link" href="page-title-boxes.html">
																<div>Boxes</div>
															</a>
														</li>
														<li class="menu-item">
															<a class="menu-link" href="page-title-blog.html">
																<div>Layout for Blogs</div>
															</a>
														</li>
														<li class="menu-item">
															<a class="menu-link" href="page-title-shop.html">
												...
												<li class="menu-item">
													...
													<ul class="sub-menu-container">
														...
														<li class="menu-item">
															<a class="menu-link" href="page-title-gmap.html">
																<div>Google Maps</div>
															</a>
														</li>
														<li class="menu-item">
															<a class="menu-link" href="page-title-gmap-mini.html">
												...
												<li class="menu-item">
													...
													<ul class="sub-menu-container">
														<li class="menu-item">
															<a class="menu-link" href="page-title.html">
																<div>Left Align</div>
															</a>
														</li>
														<li class="menu-item">
														...
														<li class="menu-item">
															<a class="menu-link" href="page-title-sticky.html">
																<div>Sticky</div>
															</a>
														</li>
													</ul>
														...
														<ul class="sub-menu-container">
															...
															<li class="menu-item">
																<a class="menu-link" href="faqs.html">
																	<div><i class="bi-question-circle"></i>FAQs Pages
																	</div>
																</a>
																<ul class="sub-menu-container mega-menu-dropdown">
																	<li class="menu-item">
															...
															<li class="menu-item">
																<a class="menu-link" href="index-rtl.html">
																	<div><i class="bi-translate"></i>RTL Template</div>
																</a>
															</li>
														</ul>
													</li>
									...
									<ul class="sub-menu-container">
										...
										<li class="menu-item">
											...
											<ul class="sub-menu-container">
												...
												<li class="menu-item">
													<a class="menu-link" href="shop-layout-2.html">
														<div>Layout 2</div>
													</a>
												</li>
												<li class="menu-item">
													<a class="menu-link" href="shop-layout-3.html">
														<div>Layout 3</div>
													</a>
												</li>
												<li class="menu-item">
													<a class="menu-link" href="shop-layout-4.html">
														<div>Layout 4</div>
													</a>
												</li>
												<li class="menu-item">
													<a class="menu-link" href="shop-layout-5.html">
														<div>Layout 5</div>
													</a>
												</li>
											</ul>
												...
												<ul class="sub-menu-container mega-menu-column col">
													...
													<li class="menu-item">
														<a class="menu-link" href="read-more.html">
															<div><i class="bi-three-dots"></i>Read More<span
																	class="visually-hidden"> Shortcode</span></div>
														</a>
													</li>
													<li class="menu-item">
													...
													<li class="menu-item">
														<a class="menu-link" href="component-datepicker.html">
															<div><i class="bi-calendar-plus"></i>Date &amp; Time Pickers
															</div>
														</a>
													</li>
													<li class="menu-item">
														<a class="menu-link" href="ticker.html">
															<div><i class="bi-wind"></i>Ticker</div>
														</a>
													</li>
													<li class="menu-item">
														<a class="menu-link" href="cart-quantity.html">
															<div><i class="bi-plus-slash-minus"></i>Cart Quantity</div>
														</a>
													</li>
												</ul>
												<ul class="sub-menu-container mega-menu-column col">
													...
													<li class="menu-item">
														<a class="menu-link" href="circle-stack.html">
															<div><i class="bi-slash-circle"></i>Circle Stack</div>
														</a>
													</li>
													<li class="menu-item">
														<a class="menu-link" href="video-facade.html">
															<div><i class="bi-play-circle"></i>Video Facade</div>
														</a>
													</li>
												</ul>
												<ul class="sub-menu-container mega-menu-column col">
													...
													<li class="menu-item">
														<a class="menu-link" href="cascading-images.html">
															<div><i class="bi-images"></i>Cascading Images</div>
														</a>
													</li>
													<li class="menu-item">
														<a class="menu-link" href="code-highlighter.html">
															<div><i class="bi-code-square"></i>Code Highlighter</div>
														</a>
													</li>
												</ul>
												<ul class="sub-menu-container mega-menu-column col">
													...
													<li class="menu-item">
														<a class="menu-link" href="hover-animations.html">
															<div><i class="bi-hand-index-thumb"></i>Hover Animations
															</div>
														</a>
													</li>
													<li class="menu-item">
													...
													<li class="menu-item">
														<a class="menu-link" href="component-select-box.html">
															<div><i class="bi-layout-three-columns"></i>Select Boxes
															</div>
														</a>
													</li>
													<li class="menu-item">
														<a class="menu-link" href="ajax-button.html">
															<div><i class="bi-filetype-js"></i>AJAX Button</div>
														</a>
													</li>
													<li class="menu-item">
														<a class="menu-link" href="conditional.html">
															<div><i class="bi-slash-square"></i>Conditional Forms</div>
														</a>
													</li>
												</ul>
												<ul class="sub-menu-container mega-menu-column col">
													...
													<li class="menu-item">
														<a class="menu-link" href="component-radios-switches.html">
															<div><i class="bi-toggle-off"></i>Radios &amp; Switches
															</div>
														</a>
													</li>
													<li class="menu-item">
													...
													<li class="menu-item">
														<a class="menu-link" href="color-mode-switcher.html">
															<div><i class="bi-moon-stars"></i>Mode Switcher</div>
														</a>
													</li>
													<li class="menu-item">
														<a class="menu-link" href="custom-cursor.html">
															<div><i class="bi-cursor"></i>Custom Cursor</div>
														</a>
													</li>
												</ul>
											</div>
	...
	<script>
		let elem = jQuery(".toggle-password");

		elem.each( function(){
			let el = jQuery(this),
				btn = el.find(".btn-password-toggle"),
				iconOn = el.attr('data-icon-on') || 'bi-eye',
				iconOff = el.attr('data-icon-off') || 'bi-eye-off',
				input = el.find('input');
